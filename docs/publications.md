...
CRISP builds on research from the Interactive & Networked Robotics Laboratory
(INRoL) on robotic multi-contact dynamics and collision geometry. The papers
below present the methods and their evaluations.
...
- S. Lee, S. Park, J. Yun, S. An, and D. J. Lee, "[CRISP: Contact-Rich Robotic Simulation Platform with Extensive Geometries and Contact Solvers](https://doi.org/10.48550/arXiv.2609.21761)," arXiv preprint, 2026.
