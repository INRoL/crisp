...
function(crisp_download_release install_prefix release_tag)
  ...
  if(crisp_verify_release)
    ...
    if(NOT expected_sha256 STREQUAL actual_sha256)
      file(REMOVE "${asset_file}" "${checksum_file}")
  ...
  set(unpack_dir "${cache_dir}/unpack")
  file(REMOVE_RECURSE "${unpack_dir}")
  file(MAKE_DIRECTORY "${unpack_dir}")
  file(ARCHIVE_EXTRACT INPUT "${asset_file}" DESTINATION "${unpack_dir}")
  if(NOT EXISTS "${unpack_dir}/lib/cmake/crisp/crisp-config.cmake")
    message(FATAL_ERROR "Release archive is missing the CRISP package config")
  endif()
  file(REMOVE_RECURSE "${install_prefix}")
  file(RENAME "${unpack_dir}" "${install_prefix}")
